---
description: Перемкнути український інженерний стиль (lite/full/ultra/normal)
argument-hint: "[lite|full|ultra|normal]"
---

Увімкни український інженерний стиль ТРЯСЦЯ рівня `$ARGUMENTS` (без аргументу — `full`). Якщо словник і сцени ще не читалися в цій сесії, прочитай:
